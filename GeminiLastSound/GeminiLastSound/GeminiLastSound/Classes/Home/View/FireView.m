...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(controlFireHeight:)];
...
- (void) controlFireHeight:(UITapGestureRecognizer *)tap{
